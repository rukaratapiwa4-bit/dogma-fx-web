...
# 🔻 LOWERED THRESHOLDS FOR TESTING — revert after testing!
BAYESIAN_DEFAULT_THRESHOLDS = {
    RegimeType.TREND    : 0.50,
    RegimeType.HV_TREND : 0.50,
    RegimeType.RANGE    : 0.50,
    RegimeType.NEWS     : 0.70,
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 12 — SELF TEST (unchanged)
# ═══════════════════════════════════════════════════════════════════════════════

if __name__ == "__main__":
    # ... (unchanged from original)
    print("Decision Engine self-test – thresholds lowered to 0.50 for testing.")
